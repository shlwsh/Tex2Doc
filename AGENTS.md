...
This project is indexed by GitNexus as **Tex2Doc** (2334 symbols, 4908 relationships, 196 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
