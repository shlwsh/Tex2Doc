...
This project is indexed by GitNexus as **Tex2Doc** (8184 symbols, 13994 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
