...
| Delete | 166 | - | - | JOSCode | - | wdecay(u,t)=sumi wi·exp(-lambda (t-ti)) (2) |
...
| Delete | 213 | - | - | - | - | 21 |
| Delete | 214 | - | - | - | - | (H, T)$ {负载自适应 |

## 格式差异

| Left# | Right# | 文本 | 字段变化 |
| ---: | ---: | --- | --- |
| 162 | 164 | Score(u,t)=α Freq(u,t)+β Err(u,t)+gamma Delay(u,t)+delta Trend(u,t) (1) | runs: `style=-;b=false;i=false;u=-;va=-;sz=-;font=Courier New/宋体 x1` -> `style=-;b=false;i=false;u=-;va=-;sz=-;font=-/- x1` |
| 598 | 558 | CostSaving(n)=StorageSaving(n)+BandwidthSaving(n)+IngestSaving(n) (4) | runs: `style=-;b=false;i=false;u=-;va=-;sz=-;font=Courier New/宋体 x1` -> `style=-;b=false;i=false;u=-;va=-;sz=-;font=-/- x1` |

## OOXML Hash

| Part | Equal | Left hash | Right hash |
| --- | --- | --- | --- |
| word/document.xml | false | f061afc60fc79cb3 | abef806ccb0811fd |
