...
const Map<AppLocale, Map<String, String>> _localized = {
  AppLocale.zhCn: {
    ...
    'extension.subtitle': '在浏览器中一键把 LaTeX 转 Word，无处不在',
    'extension.cta': '立即查看',
    'extension.install.chrome': '安装 Chrome 版',
    'extension.install.edge': '安装 Edge 版',
    'extension.install.firefox': '安装 Firefox 版',
    'extension.install.safari': '安装 Safari 版',
    'extension.featuresTitle': '核心功能',
    ...
    'extension.feature.sidepanel.body': 'Chrome / Edge 提供 SaaS 风格管理面板（Jobs / Billing / Feedback / Account）。',
    'extension.installGuide.title': '安装指南',
    'extension.installGuide.chromeSteps': '1. 打开 Chrome Web Store 搜索 "Tex2Doc"；2. 点击 "添加至 Chrome"；3. 在浏览器工具栏固定图标；4. 登录账户即可使用。',
    'extension.installGuide.edgeSteps': '1. 打开 Microsoft Edge Add-ons；2. 点击 "获取"；3. 在 Edge 中启用扩展。',
    'extension.installGuide.firefoxSteps': '1. 打开 Firefox Add-ons；2. 点击 "添加到 Firefox"；3. 允许必要权限。',
    'extension.installGuide.safariSteps': '1. 打开 Mac App Store 搜索 "Tex2Doc"；2. 下载安装；3. 在 Safari 偏好设置中启用扩展。',
    'extension.usage.popup.title': '弹出窗口',
    'extension.usage.popup.body': '点击工具栏图标打开弹出窗口，选择文件后立即转换。',
    'extension.usage.sidepanel.title': '侧边面板',
    'extension.usage.sidepanel.body': '通过侧边面板管理 Jobs / Billing / Feedback / Account。',
    'extension.usage.website.title': '网站集成',
    'extension.usage.website.body': 'Overleaf 项目页右下角、arXiv 摘要页会出现转换按钮。',
  },
  AppLocale.enUs: {
    'app.title': 'Tex2Doc',
    ...
    'extension.subtitle': 'Convert LaTeX to Word in your browser, anywhere',
    'extension.cta': 'View Now',
    'extension.install.chrome': 'Install for Chrome',
    'extension.install.edge': 'Install for Edge',
    'extension.install.firefox': 'Install for Firefox',
    'extension.install.safari': 'Install for Safari',
    'extension.featuresTitle': 'Core Features',
    'extension.feature.local.title': 'Local Conversion',
    'extension.feature.local.body': 'Browser-native conversion via WebAssembly. Files never leave your device.',
    'extension.feature.cloud.title': 'Cloud Conversion',
    'extension.feature.cloud.body': 'Upload to the Tex2Doc engine for complex documents and templates.',
    'extension.feature.overleaf.title': 'Overleaf Integration',
    'extension.feature.overleaf.body': 'One-click conversion from Overleaf project pages.',
    'extension.feature.arxiv.title': 'arXiv Support',
    'extension.feature.arxiv.body': 'One-click download and conversion from arXiv abstract pages.',
    'extension.feature.account.title': 'Account & Quota',
    'extension.feature.account.body': 'Sign in to manage plans, quotas, and redeem codes.',
    'extension.feature.sidepanel.title': 'Side Panel',
    'extension.feature.sidepanel.body': 'SaaS-style management panel in Chrome / Edge (Jobs / Billing / Feedback / Account).',
    'extension.installGuide.title': 'Installation Guide',
    'extension.installGuide.chromeSteps': '1. Open Chrome Web Store and search "Tex2Doc". 2. Click "Add to Chrome". 3. Pin the icon to the toolbar. 4. Sign in to start.',
    'extension.installGuide.edgeSteps': '1. Open Microsoft Edge Add-ons. 2. Click "Get". 3. Enable the extension in Edge.',
    'extension.installGuide.firefoxSteps': '1. Open Firefox Add-ons. 2. Click "Add to Firefox". 3. Grant the required permissions.',
    'extension.installGuide.safariSteps': '1. Open the Mac App Store and search "Tex2Doc". 2. Install the app. 3. Enable the extension in Safari preferences.',
    'extension.usage.popup.title': 'Popup',
    'extension.usage.popup.body': 'Click the toolbar icon to open the popup, pick a ZIP and start converting.',
    'extension.usage.sidepanel.title': 'Side Panel',
    'extension.usage.sidepanel.body': 'Manage Jobs / Billing / Feedback / Account in the side panel.',
    'extension.usage.website.title': 'Website Integration',
    'extension.usage.website.body': 'A Tex2Doc button appears on Overleaf project pages and arXiv abstract pages.',
  },
};
