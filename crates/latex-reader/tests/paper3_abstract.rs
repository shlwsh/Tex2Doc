use doc_latex_reader::{expand::MacroMap, include::JoinedStream, lower_with_macros, parse_tex};
use doc_semantic_ast::{Block, Document, SourceId};
...
fn paper3_main_jos_via_include_graph() {
    let latex_dir = "e:/work/Tex2Doc/examples/paper3/latex";
    ...
    fs::write("e:/work/Tex2Doc/examples/paper3/build/test-output.txt", &snippet).ok();
