...
export const Toast: React.FC<ToastProps> = ({
  ...
  return (
    <div
      className={`flex items-start p-4 rounded-lg border ${styles.container} ${className}`}
      role="alert"
    >
      ...
      {onClose && (
        <button
          onClick={onClose}
          className={`ml-3 flex-shrink-0 rounded-md p-1.5 hover:bg-gray-100 dark:hover:bg-gray-800 ${styles.text}`}
        >
